...
HD_PWD='D:/Diak/Patka/github/fpga_project/src/ila/ws2813_ila/ws2813_ila.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WS2813_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WS2813_Driver.tcl -notrace

...
HD_PWD='D:/Diak/Patka/github/fpga_project/src/ila/ws2813_ila/ws2813_ila.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WS2813_Driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WS2813_Driver.tcl
